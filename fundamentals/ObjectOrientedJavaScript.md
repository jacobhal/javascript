...
This whole sequence of having objects inherit things through the prototype properties is called the _Prototype chain_.
...
In order to see what things an object inherits, you can look at the prototype property. Either write <Object-constructor-name>.prototype in the console or console.log the entire instantiated object and expand the "**proto**" tree.
...
The old way of using inheritance was by using prototypes directly but we can do the same thing with a nicer ES6 syntax.
